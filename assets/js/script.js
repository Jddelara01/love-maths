...
function runGame(gameType) {
    ...
    if(gameType === "addition") {
        ...
        displayDivivideQuestion(num1, num2);
    } else {
...
function displayDivivideQuestion(operand1, operand2) {
    document.getElementById("operand1").textContent = operand1 > operand2 && operand1 !== operand2 ? operand1 : operand2;
    document.getElementById("operand2").textContent = operand1 > operand2 && operand1 !== operand2 ? operand2 : operand1;
    document.getElementById("operator").textContent = "/";
